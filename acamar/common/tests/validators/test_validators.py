...
class TestValidators(TestCase):
    ...
    def test_validate_user_exists_with_user_that_doesnt_exist(self):
        self.assertRaises(ValidationError, validators.validate_user_exists, 'test_username')

    def test_validate_user_exists_with_existing_user(self):
        User.objects.create_user('test_username', 'test@test.com', 'test_password')
        self.assertIsNone(validators.validate_user_exists('test_username'),
    ...
    def test_validate_user_is_active_with_inactive_user(self):
        ...
        test_user.save()
        self.assertRaises(ValidationError, validators.validate_user_is_active, 'test_username')

    def test_validate_user_is_active_with_active_user(self):
        User.objects.create_user('test_username', 'test@test.com', 'test_password')
        self.assertIsNone(validators.validate_user_is_active('username'),
